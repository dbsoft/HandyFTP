...
then
    ...
    install_name_tool -change libdwindows.so.2.2 @executable_path/libdwindows.dylib "../install/package/$APPNAME.app/Contents/MacOS/$BINNAME"
    install_name_tool -change libdwcompat.so.2.2 @executable_path/libdwcompat.dylib "../install/package/$APPNAME.app/Contents/MacOS/$BINNAME"
