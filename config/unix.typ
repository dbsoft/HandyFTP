#
# Unix entry and site type template.
#
# Site type
TYPE=UNIX
...
TIMECOL=8
# Column in which the link count is. (this is an optional field, so 
# we use this entry to determine if the link column exists or not)
LINKCOL=2
